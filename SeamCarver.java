...
//   public static void main(String args[]){
	 ...
	 //test findVerticalSeam
	 		...
	 		Integer[] vSeam = {sub2ind(0,3,6), sub2ind(1,4,6), sub2ind(2,3,6), sub2ind(3,2,6), sub2ind(4,2,6)};
	 		Integer[] hSeam = {sub2ind(2,0,6), sub2ind(2,1,6), sub2ind(1,2,6), sub2ind(2,3,6), sub2ind(1,4,6), sub2ind(2,5,6)};
	 		...
	 		Integer[] vSeam1 = {sub2ind(0,0,3), sub2ind(1,0,3), sub2ind(2,0,3), sub2ind(3,0,3)};
	 		Integer[] hSeam1 = {sub2ind(0,0,3), sub2ind(0,1,3), sub2ind(0,2,3)};
	...
	// test deltaX deltaY	   
	 ...
	 // Test tran2origIndex
	 	...
	 	Integer[] regIndices   = { sub2ind(0,0,3), sub2ind(0,1,3), sub2ind(0,2,3) };
	 	Integer[] transIndices = { sub2ind(0,0,3), sub2ind(1,0,3), sub2ind(2,0,3) };
	 	...
	 	System.out.println("    transpose Indeces mapping corectly to regular indeces: " + Arrays.deepEquals(tran2origIndex(3,3,regIndices), transIndices) );
